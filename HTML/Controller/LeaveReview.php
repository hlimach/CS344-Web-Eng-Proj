<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
	    ...
	    $result = $conn->query("INSERT INTO review (user, movie, title, review_text, review_rating) values ('".$_SESSION['userid']."','".$movie_id."','".$_POST['review-title']."', '".$_POST['review-content']."', '".$_POST['rating']."')");
